...
/// Barter utilities API for TokenBundle
#[pyclass]
#[derive(Clone)]
...
#[pymethods]
impl BarterUtils {
    /// Creates an escrow to buy one token bundle for another.
    ...
    /// Fulfills a bundle-for-bundle trade.
